...
export const es: SiteContent = {
  ...
  aperture: {
    ...
    me: {
      ...
      settingsGroups: {
        profile: "Perfil",
        location: "Ubicación y rol",
        links: "Enlaces",
        visibility: "Visibilidad",
      },
      viewProfileCta: "Ver perfil público",
    ...
    directory: {
      ...
      joinCta: "Reclamá tu número",
      countLabel: "Perfiles públicos",
      searchLabel: "Buscar miembros",
      searchPlaceholder: "Nombre, usuario o titular",
      roleFilterLabel: "Filtrar por rol",
      allRoles: "Todos",
      resultsCount: "{count} de {total}",
      noResults: "Ningún miembro coincide con estos filtros.",
